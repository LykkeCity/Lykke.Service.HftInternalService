...
namespace Lykke.Service.HftInternalService.Modules
{
    ...
    {
        private readonly IReloadingManager<HftInternalServiceSettings> _settings;
        private readonly ILog _log;
        // NOTE: you can remove it if you don't need to use IServiceCollection extensions to register service specific dependencies
        private readonly IServiceCollection _services;

        public ServiceModule(IReloadingManager<HftInternalServiceSettings> settings, ILog log)
        {
            _settings = settings;
            _log = log;
